...
using System.Text;
using Fenit.Toolbox.Android.Checksum;
using Fenit.Toolbox.Android.Core;
using Fenit.Toolbox.Android.Encryption;
using Fenit.Toolbox.Android.Zip.Compression;
using Fenit.Toolbox.Android.Zip.Compression.Streams;

namespace Fenit.Toolbox.Android.Zip
{
